...
#include <memory>
#include "../view/include/component/dialog/file_dialog.hpp"
...
QT_MOC_LITERAL(1, 11, 13), // "sigSelectFile"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "format"
QT_MOC_LITERAL(4, 33, 9), // "file_path"
QT_MOC_LITERAL(5, 43, 4), // "MODE"
QT_MOC_LITERAL(6, 48, 4), // "mode"
QT_MOC_LITERAL(7, 53, 14) // "handleOpenFile"

    },
    "FileDialog\0sigSelectFile\0\0format\0"
    "file_path\0MODE\0mode\0handleOpenFile"
};
...
void FileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigSelectFile((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< MODE(*)>(_a[3]))); break;
        ...
        {
            using _t = void (FileDialog::*)(QString , QString , MODE );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileDialog::sigSelectFile)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileDialog::sigSelectFile(QString _t1, QString _t2, MODE _t3)
{
