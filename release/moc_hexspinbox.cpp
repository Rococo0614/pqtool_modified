/****************************************************************************
** Meta object code from reading C++ file 'hexspinbox.hpp'
**
...
#include <memory>
#include "../view/include/component/register/hexspinbox.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'hexspinbox.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject HexSpinBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QSpinBox::staticMetaObject>(),
    qt_meta_stringdata_HexSpinBox.data,
